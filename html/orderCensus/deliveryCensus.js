define(function(require, exports, module) {
    ...
    var deliveryCensus = new Vue({
        el: '#deliveryCensus',
        template: _g.getTemplate('orderCensus/deliveryCensus-main-V'),
        data: {
            detail: [{
                sorting: '01',
                time: '2015-09-13',
    ...
    var getCensusData = function() {
        ...
        Http.ajax({
            ...
            isSync: true,
            url: '/jiekou/agentht/order/ordertj4.aspx',
            success: function(ret) {
                if(ret.zt == 1) {
                    setTimeout(function() {
                        if(pageIndex == 1) {
                            deliveryCensus.detail = getCensusDetail(ret.data);
                        } else {
                            deliveryCensus.detail = deliveryCensus.detail.concat(getCensusDetail(ret.data));
                        }
                    }, 0);
                } else if(ret.zt == -1) {
                    _g.hideProgress();
