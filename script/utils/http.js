define(function(require, exports, module) {
    ...
    function Http() {
        ...
        this._opts = {
            secret: 'vdr2aZhO9wer8Ty7K9G5pWOENt2P9TJp14o'
        };
        this.isLock = false;
    }
            ...
            api && api.ajax({
                ...
                if(ret){
                    ...
                    opts.success && opts.success(ret);
                     ...
                     api.alert({title: '提示',msg:UserInfo.agentid+'  ' +UserInfo.loginname +' '+UserInfo.token +' '+UserInfo.staffid+ '错误接口：'+opts.url+'，错误码：'+err.code+'，错误信息：'+err.msg+'，网络状态码：'+err.statusCode},function(){});
