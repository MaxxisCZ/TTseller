define(function(require, exports, module) {
    ...
    Vcode.prototype = {
        ...
        getVerificationCode: function(length) {
            length = length || 4;
            var VerificationCode = '';
            var RandomCode = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
            for (var i = length - 1; i >= 0; i--) {
                var number = Math.random() * 35;
                var code = Math.round(number);
                VerificationCode += RandomCode[code];
            }
